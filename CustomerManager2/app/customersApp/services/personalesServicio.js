...
app.service('personalesServicio', function(){
	...
	var personales = [
        {
            id: 1, nombre: 'Lee', apellido: 'Carroll', direccion: '1234 Anywhere St.', ciudad: 'Phoenix',
            ordenes: [
        ...
        {
            id: 2, nombre: 'Jesse', apellido: 'Hawkins', direccion: '89 W. Center St.', ciudad: 'Atlanta',
            ordenes: [
        ...
        {
            id: 3, nombre: 'Charles', apellido: 'Sutton', direccion: '455 7th Ave.', ciudad: 'Quebec',
            ordenes: [
        ...
        {
            id: 4, nombre: 'Albert', apellido: 'Einstein', direccion: '8966 N. Crescent Dr.', ciudad: 'New York ciudad',
            ordenes: [
        ...
        {
            id: 5, nombre: 'Sonya', apellido: 'Williams', direccion: '55 S. Hollywood Blvd', ciudad: 'Los Angeles'
        },
        {
            id: 6, nombre: 'Victor', apellido: 'Bryan', direccion: '563 N. Rainier St.', ciudad: 'Seattle',
            ordenes: [
        ...
        {
            id: 7, nombre: 'Lynette', apellido: 'Gonzalez', direccion: '25624 Main St.', ciudad: 'Albuquerque',
            ordenes: [
        ...
        {
            id: 8, nombre: 'Erick', apellido: 'Pittman', direccion: '33 S. Lake Blvd', ciudad: 'Chicago',
            ordenes: [
        ...
        {
            id: 9, nombre: 'Alice', apellido: 'precio', direccion: '3354 Town', ciudad: 'Cleveland',
            ordenes: [
        ...
        {
            id: 10, nombre: 'Gerard', apellido: 'Tucker', direccion: '6795 N. 53 W. Bills Dr.', ciudad: 'Buffalo',
            ordenes: [
        ...
        {
            id: 11, nombre: 'Shanika', apellido: 'Passmore', direccion: '459 S. International Dr.', ciudad: 'Orlando'
        }
    ];
});
